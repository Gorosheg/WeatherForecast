...
![Фото второго экрана](https://github.com/Gorosheg/WeatherForecast/blob/master/app/src/main/res/drawable/weather3.jpg)

Проект написан с использованием: Kotlin, Rxjava2, Room, Retrofit2, MVVM, DI, Сlean architecture.
